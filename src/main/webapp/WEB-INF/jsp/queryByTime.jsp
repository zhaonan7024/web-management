                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="number" id="begin" value="10" autocomplete="off" class="layui-input">
                            </div>
                            <div class="layui-form-mid">-</div>
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="number" id="end" value="50" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">统计范围</label>
                            <div class="layui-input-inline">
                                <input type="number" id="range" value = "5" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    <!--查询按钮-->
...
<script>
    ...
    function loadData(){
        ...
        layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
            ...
            //查询后台数据之后，刷新表数据
            $.post("${pageContext.request.contextPath}/ajax/queryByTime",{begin:$("#begin").val(), end:$("#end").val()},
        ...
        //请求后台数据
        $.post("${pageContext.request.contextPath}/ajax/queryChartByTime",{begin:$("#begin").val(), end:$("#end").val(),range:$("#range").val()},
            function (data,status) {

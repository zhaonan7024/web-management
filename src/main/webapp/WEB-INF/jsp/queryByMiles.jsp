...
<script>
    ...
    function loadData(){
        ...
        layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
            ...
            //查询后台数据之后，刷新表数据
            $.post("${pageContext.request.contextPath}/ajax/queryByMilse",{begin:$("#begin").val(), end:$("#end").val()},
        ...
        //请求后台数据
        $.post("${pageContext.request.contextPath}/ajax/queryChartByMilse",{begin:$("#begin").val(), end:$("#end").val(),range:$("#range").val()},
            function (data,status) {
